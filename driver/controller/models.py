...
#   timestamp: 2022-09-08T03:05:42+00:00
...
class DIDCreateOptions(BaseModel):
    key_type: Literal['ed25519', 'bls12381g2'] = Field(..., example='ed25519')
...
class DIDCreate(BaseModel):
    method: Optional[Literal['key', 'sov']] = Field(None, example='sov')
...
class IndyRevRegDefValue(BaseModel):
    issuanceType: Optional[
        Literal['ISSUANCE_ON_DEMAND', 'ISSUANCE_BY_DEFAULT']
    ] = Field(None, description='Issuance type')
...
class IndyRevRegDef(BaseModel):
    ...
    revocDefType: Optional[Literal['CL_ACCUM']] = Field(
        None,
