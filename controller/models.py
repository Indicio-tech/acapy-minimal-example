...
#   timestamp: 2023-12-12T16:39:26+00:00
...
class CreateWalletRequest(BaseModel):
    ...
    wallet_type: Optional[
        Literal["askar", "askar-anoncreds", "in_memory", "indy"]
    ] = Field(None, description="Type of the wallet to create", example="indy")
...
class StoredConnRecord(BaseModel):
    class Config:
        allow_population_by_field_name = True
...
class ConnectionList(BaseModel):
    ...
    results: List[StoredConnRecord] = Field(
...
class LdpIssueRequest(BaseModel):
    class Config:
        allow_population_by_field_name = True
...
class LdpIssueResponse(BaseModel):
    class Config:
        allow_population_by_field_name = True
...
class LdpVerifyRequest(BaseModel):
    class Config:
        allow_population_by_field_name = True

    options: Optional[LDProofVCOptions] = None
    vc: Optional[VerifiableCredential] = None
    vp: Optional[VerifiableCredential] = None


class LdpVerifyResponse(BaseModel):
    class Config:
        allow_population_by_field_name = True
